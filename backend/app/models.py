...
class Patient(Base):
    ...
    phone: Mapped[str | None] = mapped_column(String(40), nullable=True)
    nida: Mapped[str | None] = mapped_column(String(40), nullable=True)
    ...
    address: Mapped[str | None] = mapped_column(String(255), nullable=True)
    insurance_type: Mapped[str | None] = mapped_column(String(60), nullable=True)
    patient_category: Mapped[str] = mapped_column(String(30), default='COST_SHARING')
    ...
    ctc_number: Mapped[str | None] = mapped_column(String(80), nullable=True)
    gravida_para: Mapped[str | None] = mapped_column(String(20), nullable=True)
    edd: Mapped[date | None] = mapped_column(Date, nullable=True)
...
class Encounter(Base):
    ...
    is_new_case: Mapped[bool] = mapped_column(Boolean, default=True)
